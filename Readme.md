...
vbv_formation.exeというのが師団編成用アプリになります。vbv_calcで登録したキャラクターを読み込んで師団を編成できます。
...
加護月は称号による付与も反映されます。反対の加護月を持つ場合は常に変化なし、2つもつ場合は1.5倍or0.5倍となります。  
昼夜は自分の種族だけでなく、〇〇適応、赦免のスキルを考慮します。

地形無効はそれぞれの効果を加算した後にステータス値に乗算します。-16と+8が適用されるなら、8%の上昇になります。  
...
* ステータス増加系スキルの対応
  ...
  本来であれば指揮類と同じように活性の計算が終わった後にスキル値をかけたほうがよいです。ただ、まだ実装されていません。
